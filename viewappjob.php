    ...
    <div class="container">
      ...
      <div class="single">
          ...
          ?>
            ...
            <div class="col-md-12 view-app" data-aos="zoom-in" data-aos-duration="1500">
                 ...
                 <table class="table">
                      ...
                      <tbody id="mytable">
                           <?php
                              ...
                              $sql = "select application.appid, application.userid, user.name , jobs.title, employer.empid, application.message, application.date
                              from application
